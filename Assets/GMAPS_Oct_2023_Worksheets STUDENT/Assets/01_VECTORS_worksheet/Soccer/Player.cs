...
public class Player : MonoBehaviour
{
    ...
    float AngleToPlayer()
    {
        ...
        Vector3 vectorFromCaptainToOther = OtherPlayer.transform.position - transform.position;

        // 2. Draw the arrow to represent visually the vector AB
        DebugExtension.DebugArrow(transform.position, vectorFromCaptainToOther, Color.black);
